...
public class CreateReservationFrame implements ActionListener {
    ...
    CreateReservationFrame(JTextField fName, JTextField lName, JTextField creditCard, JTextField adress,
    ...
    CreateReservationFrame(JTextField fName, JTextField lName, JTextField resNum,
